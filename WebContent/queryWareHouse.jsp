...
<body class="cbp-spmenu-push">
						...
						<ul class="nav" id="side-menu">
							...
							<li><a href="#"><i class="fa fa-check-square-o nav_icon"></i>销售/采购管理<span
								...
								<ul class="nav nav-second-level collapse">
									...
									<li><a href="updateOrder.jsp">修改销售/退货/采购订单</a></li>
								</ul> <!-- //nav-second-level --></li>
							<li><a href="#"><i class="fa fa-envelope nav_icon"></i>仓库管理<span
								...
								<ul class="nav nav-second-level collapse">
									...
									<li><a href="updateGoods.jsp">修改货物信息</a></li>
									<li><a href="updateWareHouse.jsp">修改仓库订单信息</a></li>
						...
						<div class="panel-body">
							<form class="navbar-form navbar-left">
								<div class="form-group ">
									订单编号：<input type="number " name="wareHouseId "
										id="wareHouseId " class="form-control " placeholder="请输入订单编号 " />
								</div>
								<div class="form-group ">
									商品编号：<input type="number " name="goodsId " id="goodsId "
										class="form-control " placeholder="请输入商品编号 " />
								</div>
								<div class="form-group ">
									理由： <input type="number " name="reason " id="reason "
										class="form-control " placeholder="请输入理由 " />
								</div>
								<div class="form-group ">
									制单人： <input type="text " name="manager " id="manager "
										class="form-control " placeholder="请输入制单人 " />
								</div>

								<div class="form-group ">
									日期： <input input type="date " name="wareHouseDate "
										id="wareHouseDate " placeholder="请选择日期 " />
								</div>
								<input type="button" class="btn btn-success" id="wareHouseSubmit" value="查询"></input>
	...
	<script type="text/javascript" >
		$(function(){
			$("#wareHouseSubmit").click(function(){
			//获取用户提交的数据
			...
			$.post("OrderManagerServlet?action=queryOrderByCondition",
				{"wareHouseId":wareHouseId,"goodsId":goodsId,"reason":reason,
				"manager":manager,"wareHouseDate":wareHouseDate},
				function(data){
					var objs = $.parseJSON(data);
					$.each(objs,function(k,wareHouse){
						$("#ResultTable").append("<tr><td>" + wareHouse.wareHouseId + "</td>"
							+ "<td>" + wareHouse.goodsId + "</td>"+
							+ "<td>" + wareHouse.reason + "</td>"
							+ "<td>" + wareHouse.manager + "</td>"
							+ "<td>" + wareHouse.wareHouseDate + "</td>" +
							"<td><a href='WareHouseManagerServlet?action=preUpdate&wareHouseId=" + wareHouse.wareHouseId
							+ "' id='updateWareHouse'>修改</a><a href='WareHouseManagerServlet?action=showWareHouseInfoById&wareHouseId=" + wareHouse.wareHouseId
