									...
									<div class="form-body form-body-info">
										<form data-toggle="validator" novalidate="true"
											...
											<div class="form-group valid-form">
												异常编号： <input type="text" class="form-control"
													name="exceptionId" id="exceptionId" readonly value="${exceptionInfo.exceptionId}" required="">
											</div>
											<div class="form-group valid-form">
												报告人：  <input type="text" class="form-control"
												name="exceptionId" id="exceptionId" readonly value="${exceptionInfo.reporter}" required="">
											</div>

											<div class="form-group">
												异常情况：
												<textarea  type="text" class="form-control"
												name="exceptionId" id="exceptionId" readonly value="${exceptionInfo.exceptionSituation}" required=""></textarea>
											</div>
											<div class="form-group valid-form">
												经办人：  <input type="text" class="form-control"
												name="exceptionId" id="exceptionId" readonly value="${exceptionInfo.holder}" required="">
											</div>
											<div class="form-group valid-form">
												处理结果：  <input type="text" class="form-control"
												name="exceptionId" id="exceptionId" readonly value="${exceptionInfo.exceptionResult}" required="">
											</div>
											<div class="form-group valid-form">
												报告日期： <input type="text" class="form-control"
												name="exceptionId" id="exceptionId" readonly value="${exceptionInfo.reportDate}" required="">
											</div>
											<div class="form-group valid-form">
												处理日期：  <input type="text" class="form-control"
												name="exceptionId" id="exceptionId" readonly value="${exceptionInfo.resultDate}" required="">
											</div>

											<div class="form-group">
													<a class='btn btn-danger' role="button" ExceptionManagerServlet?action=preUpdate&exceptionId=${exceptionInfo.exceptionId}">修改</a>
											</div>
										</form>
									</div>
								</div>
