                                                ...
                                                <div class="form-body form-body-info">
                                                    <form data-toggle="validator" novalidate="true" action="WareHouseManagerServlet?action=addWareHouse" method="post">
                                                        <div class="form-group valid-form">
                                                            商品编号： <input type="text" class="form-control" name="goodId" id="goodId" placeholder="请输入商品编号" required="">
                                                        </div>
                                                        <div class="form-group valid-form">
                                                            数量： <input type="number" name="goodNumber" id="goodNumber" class="form-control" placeholder="请输入商品数量" min="0" required="">
                                                        </div>

                                                        <div class="form-group">
                                                            理由： <input type="text" name="reason" id="reason" class="form-control" placeholder="请输入理由">
                                                        </div>
                                                        <div class="form-group">
                                                            制单人： <input type="text" name="manager" id="manager" class="form-control" placeholder="请输入制单人">
                                                        </div>
                                                        <div class="form-group">
                                                            状态： <input type="number" name="state" id="state" class="form-control" min="0" max="1" placeholder="请选择状态">
                                                        </div>
                                                        <div class="form-group">
                                                            日期：
                                                            <input type="date" name="wareHouseDate" id="wareHouseDate" class="form-control">
                                                        </div>
                                                        <div class="form-group">
