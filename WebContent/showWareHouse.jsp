                        ...
                        <div class="navbar-collapse">
                            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" id="cbp-spmenu-s1">
                                <div class="scrollbar scrollbar1">
									...
									class="fa fa-book nav_icon"></i>查询用户信息</a>
                                            <!-- /nav-second-level -->
                                        </li>
                                        ...
                                        <div class="panel panel-widget">
                                            <div class="validation-grids widget-shadow" data-example-id="basic-forms">
                                                <div class="form-body form-body-info">
                                                    <form data-toggle="validator" novalidate="true" action="WareHouseManagerServlet?action=addWareHouse" method="post">
                                                            <div class="form-group valid-form">
                                                                    订单编号：  <input type="text" class="form-control"
                                                                    name="wareHouseId" id="wareHouseId" readonly value="${wareHouse.wareHouseId}" required="">
                                                                </div>
                                                        <div class="form-group valid-form">
                                                            商品编号：  <input type="text" class="form-control"
                                                            name="exceptionId" id="exceptionId" readonly value="${wareHouse.goodId}" required="">
                                                        </div>
                                                        <div class="form-group valid-form">
                                                            数量：  <input type="text" class="form-control"
                                                            name="exceptionId" id="exceptionId" readonly value="${wareHouse.goodNumber}" required="">
                                                        </div>

                                                        <div class="form-group">
                                                            理由：  <input type="text" class="form-control"
                                                            name="exceptionId" id="exceptionId" readonly value="${wareHouse.reason}" required="">
                                                        </div>
                                                        <div class="form-group">
                                                            制单人：  <input type="text" class="form-control"
                                                            name="exceptionId" id="exceptionId" readonly value="${wareHouse.manager}" required="">
                                                        </div>
                                                        <div class="form-group">
                                                            状态：  <input type="text" class="form-control"
                                                            name="exceptionId" id="exceptionId" readonly value="${wareHouse.state}" required="">
                                                        </div>
                                                        <div class="form-group">
                                                            日期：
                                                            <input type="text" class="form-control"
                                                            name="exceptionId" id="exceptionId" readonly value="${wareHouse.wareHouseDate}" required="">
                                                        </div>
                                                        <div class="form-group">
                                                                <a class='btn btn-danger' role="button" href="WareHouseManagerServlet?action=preUpdate&wareHouseId=${wareHouse.wareHouseId}">修改</a>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
