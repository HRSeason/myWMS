								...
								<div class="validation-grids widget-shadow"
									...
									<div class="form-body form-body-info">
										<form data-toggle="validator" novalidate="true"
											action="GoodsManagerServlet?action=addGoods" method="post">
											<div class="form-group">
												货物名称： <input type="text" class="form-control"
													name="goodName" id="goodName" placeholder="请输入货物名称"
													required="">
											</div>

											<div class="form-group valid-form">
												库存数量： <input type="number" class="form-control"
													name="stockNumber" id="stockNumber" placeholder="请输入库存数量"
													required="">
											</div>
											<div class="form-group">
												库存位置： <select name="locationwarehouse" class="form-control">
													<option value="A仓">A</option>
													<option value="B仓">B</option>
													<option value="C仓">C</option>
												</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;仓 <select name="locationdepart" class="form-control">
												 ...
												 <select name="locationfloor" class="form-control">
													<option value="一层">一</option>
													<option value="二层">二</option>
													<option value="三层">三</option>
													<option value="四层">四</option>
												</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;层 <input type="text" class="form-control" name="stockNumber"
													name="locationdetal" id="locationdetal" required="">
											</div>

											<div class="form-group">
												类型： <select name="goodType" class="form-control"
													id="goodType">
													<option value="家用电器">家用电器</option>
													<option value="办公用品">办公用品</option>
													<option value="特殊物品">特殊物品</option>
												</select>
											</div>
											<div class="form-group">
