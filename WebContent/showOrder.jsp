								...
								<div class="validation-grids widget-shadow"
									...
									<div class="form-body form-body-info">
										<form data-toggle="validator" novalidate="true">
												...
												订单编号： <input type="text" class="form-control" name="goodId"
													id="orderId" value="${order.orderId}" required="" readonly>
											</div>
											<div class="form-group">
												订单种类：  <input type="text" class="form-control" name="goodId"
												id="orderId" value="${order.orderType }" required="" readonly>
											</div>

											<div class="form-group valid-form">
												商品编号：  <input type="text" class="form-control" name="goodId"
												id="orderId" value="${order.goodId }" required="" readonly>
											</div>
											<div class="form-group valid-form">
												数量：  <input type="text" class="form-control" name="goodId"
												id="orderId" value="${order.goodNumber }" required="" readonly>
											</div>

											<div class="form-group">
												经办人： <input type="text" class="form-control" name="goodId"
												id="orderId" value="$${order.orderOperator }" required="" readonly>
											</div>
											<div class="form-group">
												制单人： <input type="text" class="form-control" name="goodId"
												id="orderId" value="${order.documentMaker }" required="" readonly>
											</div>
											<div class="form-group">
												状态： <input type="text" class="form-control" name="goodId"
												id="orderId" value="${order.orderState}" required="" readonly>
											</div>
											<div class="form-group">
												日期：
												<input type="text" class="form-control" name="goodId"
												id="orderId" value="${order.orderDate }" required="" readonly>
											</div>
											<div class="form-group">
