									...
									<div class="form-body form-body-info">
										<form data-toggle="validator" novalidate="true">
											<div class="form-group valid-form">
												库存数量： <input type="text" class="form-control" name="goodId"
													id="goodId" value="${good.goodId}" readonly required="">
											</div>
											<div class="form-group">
												货物名称： <input type="text" class="form-control"
													name="goodName" id="goodName" required=""
													value="${good.goodName}" readonly>
											</div>

											<div class="form-group valid-form">
												库存数量： <input type="number" class="form-control"
													name="stockNumber" id="stockNumber"
													value="${good.stockNumber}" required="" readonly>
											</div>
											<div class="form-group">
												库存位置： <input type="text" class="form-control"
													name="location" id="location" value="${good.location}"
													required="" readonly>
											</div>

											<div class="form-group">
												类型： <input type="text" class="form-control" name="goodType"
													id="goodType" value="${good.goodType}" required="" readonly>
											</div>
											<div class="form-group">
												<a class="form-control"
													href="GoodsManagerServlet?action=preUpdate&goodId=${good.goodId }">修改</a>
											</div>
										</form>
									</div>
								</div>
