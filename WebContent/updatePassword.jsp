								...
								<div class="validation-grids widget-shadow"
									...
									<div class="form-body form-body-info">
										<form data-toggle="validator" novalidate="true"
											action="UserManagerServlet?action=updatePassword" method="post">
											
											<div class="form-group">
												原密码： <input type="password" data-toggle="validator"
													data-minlength="6" class="form-control" name="oldUserPass"
													id="oldUserPass" placeholder="请输入原密码">
											</div>
											<div class="form-group">
												新密码： <input type="password" data-toggle="validator"
													data-minlength="6" class="form-control" name="newUserPass1"
													id="newUserPass1" placeholder="请输入新密码">
											</div>
											<div class="form-group">
												再次输入密码： <input type="password" data-toggle="validator"
													data-minlength="6" class="form-control" name="newUserPass2"
													id="newUserPass2" placeholder="请再输入新密码">
											</div>
											<div class="form-group">
