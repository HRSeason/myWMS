						...
						<li class="dropdown profile_details_drop"><a href="#"
							...
							aria-expanded="false">
								<div class="profile_img">
									<span style="display:inline-block;margin-top:15px">欢迎您，${user.userName}</span>
									<div class="clearfix"></div>
								</div>
						</a></li>
					</ul>
										...
										<form data-toggle="validator" novalidate="true"
											...
											<div class="form-group valid-form">
												异常编号： <input type="text" class="form-control"
													name="exceptionId" id="exceptionId" disabled
													placeholder="******" required="">
											</div>
											<div class="form-group valid-form">
												报告人： <input type="text" name="reporter" id="reporter"
													class="form-control" placeholder="请输入报告人" required="">
											</div>

											<div class="form-group">
												异常情况：
												<textarea name="exceptionSituation" id="exceptionSituation"
													class="form-control" rows="5" cols="20"></textarea>
											</div>
											<div class="form-group valid-form">
												经办人： <input type="text" name="holder" id="holder"
													class="form-control" placeholder="请输入经办人" required="">
											</div>
											<div class="form-group valid-form">
												处理结果： <input type="text" name="exceptionResult"
													id="exceptionResult" class="form-control"
													placeholder="请输入处理结果" required="">
											</div>
											<div class="form-group valid-form">
												报告日期： <input type="date" name="reportDate" id="reportDate"
													class="form-control" placeholder="请输入处理结果" required="">
											</div>
											<div class="form-group valid-form">
												处理日期： <input type="date" name="resultDate" class="form-control" id="resultDate"
													placeholder="请输入处理结果" required="">
											</div>
