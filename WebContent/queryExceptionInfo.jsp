						...
						<div class="panel-body">
							<form class="navbar-form navbar-left">
								<div class="form-group">
									异常编号：<input type="number" name="exceptionId" id="exceptionId"
										class="form-control" placeholder="请输入异常编号" />
								</div>
								<div class="form-group">
									报告人： <input type="text" name="reporter" id="reporter"
										class="form-control" placeholder="请输入报告人" />
								</div>
								<div class="form-group">
									经办人： <input type="text" name="holder" id="holder"
										class="form-control" placeholder="请输入经办人" />
								</div>
								<div class="form-group">
									报告日期： <input type="date" name="reportDate" id="reportDate"
										class="form-control" placeholder="请输入经办人" />
								</div>
								<div class="form-group">
									处理日期： <input type="date" name="resultDate" id="resultDate"
										class="form-control" placeholder="请输入经办人" />
								</div>
								<input type="button" class="btn btn-success" id="exceptionSubmit" value=" 查 询 "></input>
						</div>
						</form>
					</div>
					<div class="tables">
...
<script type="text/javascript" >
	$(function(){
		$("#exceptionSubmit").click(function(){
		//获取用户提交的数据
		...
		//使用jQuery提交ALAX请求
		$.post("ExceptionManagerServlet?action=queryExceptionByCondition",
			{"exceptionId":exceptionId,"reporter":reporter,"holder":holder,
			"reportDate":reportDate,"resultDate":resultDate},
			function(data){
				var objs = $.parseJSON(data);
				$.each(objs,function(k,exceptionInfo){
					$("#ResultTable").append("<tr><td>" + exceptionInfo.exceptionId + "</td>"
						+ "<td>" + exceptionInfo.reporter + "</td>"+
						+ "<td>" + exceptionInfo.holder + "</td>"
						+ "<td>" + exceptionInfo.reportDate + "</td>"
						+ "<td>" + exceptionInfo.resultDate + "</td>" +
						"<td><a class='btn btn-info'  role='button'  href='ExceptionManagerServlet?action=preUpdate&exceptionId=" + exceptionInfo.exceptionId
						+ "' id='updateWareHouse'>修改</a><a class='btn btn-danger' role='button' href='ExceptionManagerServlet?action=showWareHouseInfoById&exceptionId=" + exceptionInfo.exceptionId
						+ "' id='showWareHouse'>查看</a><td></tr>");
				});
			});
		});
	});
