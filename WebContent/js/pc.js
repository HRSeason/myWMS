...
$(document).ready(function() {
  ...
  myfunction(
    $(".container .menu .ulmenu1 li"),
    $(".container .ulmenu1 li a"),
    $(".container .content .menu1 .tab")
  );
  myfunction(
    $(".container .menu .ulmenu2 li"),
    $(".container .ulmenu2 li a"),
    $(".container .content .menu2 .tab")
  );
  myfunction(
    $(".container .menu .ulmenu3 li"),
    $(".container .ulmenu3 li a"),
  ...
  $(function() {
    ...
    $(".menu h3").click(function() {
      ...
      $(".container .menu .ulmenu" + menu_value + " li>a").removeClass(
        "selected"
      );
      $(".container .menu .ulmenu" + menu_value + " li a")
        .eq(0)
        .addClass("selected"); //默认设置为被选中状态
...
setInterval(function() {
  $("#systemtime").html(new Date().Format("yyyy-MM-dd hh:mm:ss"));
}, 1000);
